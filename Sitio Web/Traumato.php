...
<head>
    ...
    <title>Fisio On Ma | T. Traumatológico </title>
</head>
<body>
...
<!-- =========================ACERCA DE T. Traumatologico====================================-->

<div class="section-abt">
    <div class="container-abt">
        <div class="titulo-abt">
            <h1>¿Qué es el Tratamiento Traumatológico?</h1>
        </div>
        ...
        <div class="contenido-abt">
            <div class="articulo-abt">
                <h3>¿En qué consiste? </h3>
                    <p>Una de las claves de la fisioterapia traumatológica: evitar los efectos negativos de la inmovilidad. 
                        Estos efectos negativos pueden ser sobre la musculatura o sobre el sistema neuromuscular, encontrando 
                        también algunos sobre ligamientos o sobre el tejido cartilaginoso. Brindamos tratamientos Post Quirúrgicos, 
                        Fractura Post Traumática, Pre-Quirúrgico y Fractura de Cadera.</p>

                                <h3>¿Qué beneficios? </h3>
                                <p>- Alivio del dolor.<br>
                                    - Recuperación de la funcionalidad y movilidad. <br>
                                    - Optimización del proceso de curación.<br>
                                    - Aumento considerable de la fuerza.<br>
                                    - Prevenir la posibilidad de recaer.<br>
                                    - Aumentar la autonomía del paciente.<br>
                                </p>
                    <div class="bton-abt">
        ...
        <div class="imag-abt">
            <img src="Images/traumatologicos.png">
        </div>
